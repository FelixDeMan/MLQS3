...
class VisualizeDataset:
    ...
    def save(self, plot_obj, formats=('png', 'pdf'), fig_name = None): # 'svg'
        if fig_name is None:
    ...
    def plot_dataset(self, data_table, columns, match='like', display='line', figname = None):
    ...
    def plot_xy(self, x, y, method='plot', xlabel=None, ylabel=None, xlim=None, ylim=None, names=None,
        ...
        self.save(plt, fig_name= fig_name)
        plt.show()

    def plot_dataset_boxplot(self, dataset, cols, figname = None):
    ...
    def plot_binary_outliers(self, data_table, col, outlier_col, k = None, figname = None):
    ...
    def plot_confusion_matrix(self, cm, classes, normalize=False, fig_name = None):
    ...
    def plot_performances(self, algs, feature_subset_names, scores_over_all_algs, ylim, std_mult, y_name, fig_name = None):
    ...
    def plot_performances_classification(self, algs, feature_subset_names, scores_over_all_algs, fig_name  = None):
        self.plot_performances(algs, feature_subset_names, scores_over_all_algs, [0.70, 1.0], 2, 'Accuracy', fig_name)
