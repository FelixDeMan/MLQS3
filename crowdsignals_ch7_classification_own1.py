...
train_X, test_X, train_y, test_y = prepare.split_single_dataset_classification1(dataset, ['label'], 'like', 0.7, filter=True, temporal=False)
...
basic_features = ['acc_phone_x','acc_phone_y','acc_phone_z','gyr_phone_x','gyr_phone_y','gyr_phone_z','lin_acc_x', 'lin_acc_y', 'lin_acc_z'
                  ]
...
DataViz.plot_xy(x=[range(1, N_FORWARD_SELECTION+1)], y=[ordered_scores],
                xlabel='number of features', ylabel='accuracy', fig_name='ordered_scores1')


# based on python2 features, slightly different. 
selected_features = ['acc_phone_y_freq_0.0_Hz_ws_50',
                     'acc_phone_x_freq_1.9_Hz_ws_50', ]
...
DataViz.plot_xy(x=[reg_parameters, reg_parameters], y=[performance_training, performance_test], method='semilogx',
                ...
                names=['training', 'test'], line_styles=['r-', 'b:'], fig_name= 'reg_param1')
...
DataViz.plot_xy(x=[leaf_settings, leaf_settings], y=[performance_training, performance_test],
                ...
                names=['training', 'test'], line_styles=['r-', 'b:'], fig_name= 'train_test1')
...
DataViz.plot_performances_classification(['NN', 'RF','SVM', 'KNN', 'DT', 'NB'], feature_names, scores_over_all_algs, fig_name= 'performance1')
...
DataViz.plot_confusion_matrix(test_cm, class_train_prob_y.columns, normalize=False, fig_name= 'conf_matrix01')
DataViz.plot_confusion_matrix(test_cm, class_train_prob_y.columns, normalize=False, fig_name= 'conf_matrix02')
