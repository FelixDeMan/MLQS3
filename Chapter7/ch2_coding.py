...
RESULT_FNAME1 = 'chapter2_result_database_1.csv'
RESULT_FNAME2 = 'chapter2_result_database_2.csv'
...
for milliseconds_per_instance in GRANULARITIES:
    ...
    DataViz.plot_dataset_boxplot(dataset, ['lin_acc_x', 'lin_acc_y', 'lin_acc_z'])
