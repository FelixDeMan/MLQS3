...
DataViz.plot_xy(x=[range(1, N_FORWARD_SELECTION+1)], y=[ordered_scores],
                xlabel='number of features', ylabel='accuracy', fig_name= 'og_ordered')
...
DataViz.plot_xy(x=[reg_parameters, reg_parameters], y=[performance_training, performance_test], method='semilogx',
                ...
                names=['training', 'test'], line_styles=['r-', 'b:'], fig_name= 'og_reg_param')
...
DataViz.plot_xy(x=[leaf_settings, leaf_settings], y=[performance_training, performance_test],
                ...
                names=['training', 'test'], line_styles=['r-', 'b:'], fig_name= 'og_train_test')
...
DataViz.plot_performances_classification(['NN', 'RF','SVM', 'KNN', 'DT', 'NB'], feature_names, scores_over_all_algs, fig_name= 'og_performance')
...
DataViz.plot_confusion_matrix(test_cm, class_train_prob_y.columns, normalize=False, fig_name= 'og_confusion')
