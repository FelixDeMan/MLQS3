...
class FourierTransformation:
    ...
    def abstract_frequency(self, data_table, columns, window_size, sampling_rate):
        ...
        for col in columns:
            ...
            frequencies = np.pad(np.array(self.temp_list), ((50, 0), (0, 0)),
    ...
    def smoothed_avg(self, data_table, columns):
        print(data_table)
        print(data_table.columns)
        data_table['engineered'] = data_table['acc_phone_x_max_freq'] * data_table['acc_phone_x_pse']
